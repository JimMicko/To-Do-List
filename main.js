...
function removeItem(){
    if(task5.style.display == "flex"){
        ...
        date4.removeAttribute("style")
        time4.removeAttribute("style")
        list4.removeAttribute("style")
        ...
        date3.removeAttribute("style")
        time3.removeAttribute("style")
        list3.removeAttribute("style")
        editBtn3.setAttribute("style","display: none !important")
        finishBtn3.setAttribute("style","display: none !important")
    }
    else if(task3.style.display == "flex"){
        task3.setAttribute("style", "display: none !important")
        date2.removeAttribute("style")
        time2.removeAttribute("style")
        ...
        date1.removeAttribute("style")
        time1.removeAttribute("style")
        list1.removeAttribute("style")
